return function(palette, groups, styles, config, make_border)
	return {
		...
		Directory = { fg = palette.red, bold = styles.bold },
		-- EndOfBuffer = {},
		...
		Boolean = { fg = palette.mgt },
		Character = { fg = palette.grn2 },
