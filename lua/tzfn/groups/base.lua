return function(palette, groups, styles, config, make_border)
	return {
		...
		Conditional = { fg = palette.red3 },
		Constant = { fg = palette.mgt },
		Debug = { fg = palette.ylw },
		Define = { fg = palette.grn2 },
		Delimiter = { fg = palette.subtle },
		Error = { fg = palette.red2 },
		Exception = { fg = palette.red3 },
		Float = { fg = palette.ylw },
		Function = { fg = palette.grn },
		Identifier = { fg = palette.fg, italic = styles.italic },
		Include = { fg = palette.grn2 },
		Keyword = { fg = palette.red2 },
		...
		LspReferenceRead = { bg = palette.hl2 },
		LspReferenceText = { bg = palette.hl2 },
		LspReferenceWrite = { bg = palette.hl2 },
		Macro = { fg = palette.grn2 },
		Number = { fg = palette.ylw },
		Operator = { fg = palette.subtle },
		PreCondit = { fg = palette.grn2 },
		PreProc = { link = "PreCondit" },
		Repeat = { fg = palette.red3 },
		Special = { fg = palette.red },
		SpecialChar = { link = "Special" },
		SpecialComment = { fg = palette.red },
		Statement = { fg = palette.red3, bold = styles.bold },
		StorageClass = { fg = palette.blu },
		String = { fg = palette.ylw },
		Structure = { fg = palette.blu },
		Tag = { fg = palette.red },
		Todo = { fg = palette.grn, bg = palette.grn3, blend = 20 },
		Type = { fg = palette.blu },
		TypeDef = { link = "Type" },
